...
def get_gasoline_data():
    ...
    with sync_playwright() as p:
        ...
        page.goto('https://tradingeconomics.com/vietnam/exports/coffee-tea-mate-spices', timeout=60000)
...
try:
    ...
    if not df.empty:
        ...
        print(df.head())
        df.to_csv('data/raw/vietnam_coffee,tea,mate,spices.csv', index=False)
